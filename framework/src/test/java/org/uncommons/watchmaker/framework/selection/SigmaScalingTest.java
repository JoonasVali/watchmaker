...
public class SigmaScalingTest {
  ...
  public void testNoVariance() {
    SelectionStrategy<Object> selector = new SigmaScaling();
    List<EvaluatedCandidate<String>> population = new ArrayList<>(4);
    EvaluatedCandidate<String> steve = new EvaluatedCandidate<>("Steve", 4.0);
    EvaluatedCandidate<String> john = new EvaluatedCandidate<>("John", 4.0);
    EvaluatedCandidate<String> mary = new EvaluatedCandidate<>("Mary", 4.0);
    EvaluatedCandidate<String> gary = new EvaluatedCandidate<>("Gary", 4.0);
    population.add(steve);
    population.add(john);
    population.add(mary);
    population.add(gary);
