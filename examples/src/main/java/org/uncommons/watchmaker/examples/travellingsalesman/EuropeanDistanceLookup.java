...
public final class EuropeanDistanceLookup implements DistanceLookup {
  ...
  static {
    ...
    Map<String, Integer> amsterdam = new HashMap<>(20);
    ...
    Map<String, Integer> athens = new HashMap<>(20);
    ...
    Map<String, Integer> berlin = new HashMap<>(20);
    ...
    Map<String, Integer> brussels = new HashMap<>(20);
    ...
    Map<String, Integer> copenhagen = new HashMap<>(20);
    ...
    Map<String, Integer> dublin = new HashMap<>(20);
    ...
    Map<String, Integer> helsinki = new HashMap<>(20);
    ...
    Map<String, Integer> lisbon = new HashMap<>(20);
    ...
    Map<String, Integer> london = new HashMap<>(20);
    ...
    Map<String, Integer> luxembourg = new HashMap<>(20);
    ...
    Map<String, Integer> madrid = new HashMap<>(20);
    ...
    Map<String, Integer> paris = new HashMap<>(20);
    ...
    Map<String, Integer> rome = new HashMap<>(20);
    ...
    Map<String, Integer> stockholm = new HashMap<>(20);
    ...
    Map<String, Integer> vienna = new HashMap<>(20);
