...
public class BitsExample {
  ...
  public static BitString evolveBits(int length) {
    List<EvolutionaryOperator<BitString>> operators = new ArrayList<>(2);
    ...
    GenerationalEvolutionEngine<BitString> engine = new GenerationalEvolutionEngine<>(new BitStringFactory(length),
        pipeline,
